...
const socialLinks = [
  { icon: Instagram, label: "Instagram", href: "https://instagram.com/1stclassmediagroup" },
  { icon: Facebook, label: "Facebook", href: "https://www.facebook.com/firstclassmediagroup" },
];
