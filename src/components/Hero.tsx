...
const Hero = () => {
  return (
    <section className="min-h-screen bg-gradient-hero relative overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-6 py-8 lg:py-20 relative">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center lg:min-h-[80vh]">
          {/* Book Image */}
          <motion.div
          ...
          >
            <div className="relative">
              ...
              <motion.img
                ...
                className="w-36 md:w-96 lg:w-[28rem] relative z-10 [filter:drop-shadow(0_20px_28px_rgb(0_0_0/0.28))]"
                animate={{ y: [0, -10, 0] }}
